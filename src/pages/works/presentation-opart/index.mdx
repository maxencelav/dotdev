...
description: 'Présentation du programme OpArt, réalisé en première en tant que projet final d’ICN.'
legacy: true
unlisted: false
---
import { Image } from 'astro:assets';
import InstructionsVasarely from './instructionsVasarely.png'
import OpartVasarely from './OpartVasarely.mp4'
import OpartAide from './OpartAide.mp4'
...
<Image src={InstructionsVasarely} alt="Illustration des actions associées aux touches du clavier" />
...
<source src={OpartVasarely} type="video/mp4"/>
</video>
...
<video width="100%" controls muted>
<source src={OpartAide} type="video/mp4"/>
</video>
